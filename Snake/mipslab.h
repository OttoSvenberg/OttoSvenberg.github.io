...
extern uint8_t space[128*4];
extern uint8_t array[128*32];  //vi har skrivit
extern uint8_t larray[128*32];    //vi har skrivit
extern uint8_t applearray[128*32];   //vi har skrivit
//extern const uint8_t const snake[5];
